classdef pipeDataServer < handle
    % A class which connects to the class pipeDataClient and creates a
    ...
    properties (Hidden = true)
        pipeStream                % NamedPipeServerStream object
    end
    ...
    methods
        % Constructor
        function this = pipeDataServer(pipeName)
            ...
            this.pipeStream = System.IO.Pipes.NamedPipeServerStream(this.pipeName, ...
                System.IO.Pipes.PipeDirection.InOut, ...
                System.IO.Pipes.NamedPipeServerStream.MaxAllowedServerInstances,...
                System.IO.Pipes.PipeTransmissionMode.Byte,...
                System.IO.Pipes.PipeOptions.Asynchronous);
            debugPrint(this,'Server pipe')
        end
        
        function this = WaitForConnection(this)
            % Wait for Client to connect... 
            debugPrint(this,'Opening pipe.')
            asyncResult = this.pipeStream.BeginWaitForConnection([],[]);
            connected = asyncResult.AsyncWaitHandle.WaitOne(this.timeOutInMs);
            if connected
                % if timeout has been hit... EndWaitForConnection will wait forever...
                this.pipeStream.EndWaitForConnection(asyncResult);
            end
            this.IsConnected = this.pipeStream.IsConnected;
            
            if this.pipeStream.IsConnected
                debugPrint(this,'Pipe connected.')
            else
                debugPrint(this,'Pipe not connected - timeout?')
            end
        end
